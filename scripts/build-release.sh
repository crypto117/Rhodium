...
# -- Config
GITHUB_REPO="https://github.com/crypto117/rhodium.git"
CLONE_DIR="$BUILD_DIRECTORY/rhodiumcoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/rhodiumcoin-releases"
DYNAMIC_RELEASE="rhodiumcoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="rhodiumcoin-${TAG_VERSION}-linux-staticboost-CLI"
